...
# --- NEW: Ensure Flutter is the latest stable version ---
RUN flutter upgrade
...
# Accept licenses, update SDK, and install common Android components
RUN yes | sdkmanager --licenses && \
    sdkmanager --update && \
    sdkmanager "platform-tools" "platforms;android-34" "build-tools;34.0.0" "ndk-bundle"
